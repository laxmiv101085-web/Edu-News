      ...
      >
        ...
        <Card className="p-8 shadow-deep border-none">
          <form className="space-y-5">
            ...
            <Button className="w-full justify-center py-3 text-base" size="lg">
              Sign In
            </Button>
          </form>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              <Button variant="outline" className="justify-center">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-.54-.25-1.1-.5-1.71-.5-.61 0-1.18.25-1.71.5-1.03.48-2.1.55-3.08-.4-1.97-1.9-3.34-5.5-1.76-9.62 1.28-3.34 4.4-4.04 5.97-1.61.24.37.49.78.75 1.22.26-.44.51-.85.75-1.22 1.57-2.43 4.69-1.73 5.97 1.61 1.58 4.12.21 7.72-1.76 9.62zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
                </svg>
                Apple
              </Button>
            </div>
