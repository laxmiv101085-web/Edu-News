...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showSuccess("Account created successfully! Welcome to EduNews.");
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-[#0B0E14] text-white font-sans selection:bg-purple-500/30">
      {/* Full-screen Gradient Background */}
      <div className="absolute inset-0 bg-gradient-to-bl from-[#0f172a] via-[#0B0E14] to-black z-0" />

      {/* Ambient Glows / Blurred Circles */}
      <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] bg-cyan-600/20 rounded-full blur-[120px] pointer-events-none animate-pulse" />
      ...
      >
        ...
        <div className="w-full backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl shadow-2xl p-8 relative overflow-hidden group">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500/20 to-cyan-500/20 border border-white/10 mb-4 shadow-[0_0_30px_rgba(6,182,212,0.15)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label htmlFor="name" className="block text-xs font-medium text-gray-400 uppercase tracking-wider ml-1">
                Full Name
              </label>
              <input
                type="text"
            ...
            <button
              ...
              className="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-purple-600 to-cyan-500 text-white font-bold text-sm uppercase tracking-wide shadow-lg shadow-cyan-500/20 hover:shadow-[0_0_20px_rgba(6,182,212,0.4)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
